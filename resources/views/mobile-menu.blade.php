<nav class="grid grid-cols-2 gap-2" aria-labelledby="mobile navigation">
    ...
    <a href="{{ route('help.user') }}" class="p-6 bg-indigo-500 dark:bg-zinc-800 bg-gradient-to-br from-indigo-600 to-indigo-400 dark:from-gray-900 dark:to-gray-500 rounded-md">
