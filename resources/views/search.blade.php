<form action="{{ request()->routeIs(['pref', 'area']) ? url()->current() : route('index') }}"
    ...
    <x-jet-input name="q" type="search" class="block flex-auto min-w-max w-full dark:bg-gray-800"
                 value="{{ request('q') }}"
    ...
    <x-jet-button class="block min-w-max w-full text-base mt-3" title="検索">検索</x-jet-button>
</form>
