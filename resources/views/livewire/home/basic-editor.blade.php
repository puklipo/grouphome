        ...
        <x-box-edit>
            ...
            <form wire:submit="save">
                ...
                <x-input type="date" name="released_at" id="released_at" rows="2"
                             wire:model="home.released_at"></x-input>
                <div class="text-sm text-gray-500 dark:text-white mb-3">指定年月日。</div>

                <x-label for="wam" value="{{ __('WAM URL') }}"/>
                <x-input type="text" name="wam" id="wam" wire:model="home.wam" class="w-full"></x-input>
                ...
                <x-textarea name="map" id="map" rows="2" wire:model="home.map"></x-textarea>
