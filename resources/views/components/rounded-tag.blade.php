...
@else
    <span {{ $attributes->class(['text-md bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 text-gray-500 rounded-full px-3 py-1 m-1 opacity-70']) }} title="{{ $slot }}"><del class="no-underline print:opacity-90">{{ $slot }}</del></span>
@endif
