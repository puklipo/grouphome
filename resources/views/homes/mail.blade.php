<div class="relative">
    <div
        ...
        @if($home->users()->exists())
            <div class="text-lg bg-emerald-500 text-white dark:bg-white dark:text-gray-900 p-3 font-bold shadow-lg rounded-lg">
        ...
        @isset($home->tel)
            <div class="text-lg bg-orange-500 text-white dark:bg-gray-900 dark:text-white p-3 font-bold shadow-lg rounded-lg">
                <a href="tel:{{ $home->tel }}">
