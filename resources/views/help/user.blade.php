    ...
    <div class="py-6">
        <div class="px-6 lg:px-8">
            ...
            <div class="prose dark:prose-invert prose-indigo prose-a:text-indigo-500 max-w-none">
                ...
                <p>
                    検索する時は自分の区分以下を指定します。区分1の人が利用できるグループホームを探すには「区分なし」や「1以上」を指定して検索してください。「2以上」を指定した時に「なしや1も含めて表示」や逆に「2以上の3,4,5,6も含めて表示」するような動作はしません。表示する区分を複数選択するには<a href="{{ route('detail-search') }}">詳細検索</a>を使用してください。
                </p>
                ...
                <ol>
                    ...
                    <li>メールアドレスの入力ミスを防ぐため、最初に自分のメールアドレスを入力します。入力したメール宛に問い合わせフォームのURLが送られるので正しいメールアドレスを入力したことが確認されます。</li>
                    <li>届いた問い合わせフォームから送信してください。</li>
                </ol>
