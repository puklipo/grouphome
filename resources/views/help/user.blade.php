    ...
    <div class="py-6">
        <div class="px-6 lg:px-8">
            ...
            <div class="prose dark:prose-invert prose-indigo prose-a:text-indigo-500 max-w-none">
                ...
                <p>
                    検索する時は自分の区分以下を指定します。区分1の人が利用できるグループホームを探すには「区分なし」や「1以上」を指定して検索してください。「2以上」を指定した時に「なしや1も含めて表示」や逆に「2以上の3,4,5,6も含めて表示」するような動作はしません。区分で制限されるのは区分1,2の利用者と予想されるので条件を変えながら検索してください。
                </p>
