        ...
        <div class="sm:px-6 lg:px-8">
            ...
            <div class="prose dark:prose-invert prose-indigo prose-a:text-indigo-500 max-w-none">
                ...
                <ol>
                    ...
                    <li>グループホームのページの一番下に「管理事業者として申請」ボタンがあるので申請。</li>
                ...
                <h2>ダッシュボード</h2>
                <ol>
                    <li>管理事業者として承認されたグループホームはダッシュボードの管理グループホーム一覧に表示されます。</li>
                </ol>

                <h2>グループホーム情報の更新</h2>
                <ol>
                    <li>管理事業者はグループホームのページで直接変更できます。</li>
                    <li>「更新」ボタンのある項目はボタンを押したタイミングで更新、それ以外のチェックボックスなどは変更したらすぐに更新が反映されます。</li>
                </ol>
