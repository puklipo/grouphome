    ...
    <div class="py-6">
        ...
        <div class="sm:px-6 lg:px-8">
            ...
            <div class="prose dark:prose-invert prose-indigo prose-a:text-indigo-500 max-w-none p-3">
                ...
                <div class="text-red-500">現在はすべて無料で利用できますが今後一部の機能を有料化する可能性はあります。</div>

                <h2>ユーザー登録</h2>
                <ol>
                    <li><a href="{{ route('register') }}">ユーザー登録ページ</a>から登録します。</li>
                    <li>確認用のメールが届きます。</li>
                </ol>
                ...
                <ol>
                    ...
                    <li>自由にユーザー登録できるということは申請したユーザーが本物のグループホーム事業者かどうか確認できないので念の為<a
