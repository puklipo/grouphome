    ...
    <div class="py-6">
        ...
        <div class="sm:px-6 lg:px-8">
            ...
            <div class="prose dark:prose-invert prose-indigo prose-a:text-indigo-500 max-w-none p-3">
                ...
                <h2>事業者向けサービス</h2>
                <div>
                    管理事業者として登録するとグループホームの詳細情報を入力する機能やお問い合わせを受け取る機能を利用できます。
                </div>
                ...
                <ol>
                    ...
                    <li>登録時の名前とメールアドレスは外部には公開されません。</li>
                    <li>確認用のメールが届きます。メールが届かない場合は登録時のメールアドレスを間違えているので<a
                            href="{{ route('profile.show') }}">プロフィールページ</a>で変更してください。
                    </li>
                </ol>
                ...
                <ul>
                    <li>
                        新しいグループホームの情報を追加するには先にWAM
                        NETに登録してください。WAMのオープンデータが更新されたら追加されますがオープンデータは半年に一度しか更新されないので、すぐに掲載したい場合は以下の情報を<a
                    ...
                    <li>グループホームが追加されたら管理事業者として登録し他の情報も更新できます。</li>
                    <li>
                        WAMのオープンデータが更新された後はWAM側の情報に上書きされます。上記はWAMが更新される前に掲載するための特殊な登録方法です。
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        どちらが正規の事業者か調査して対応を決めます。先に登録していたほうも実は関係者だったという可能性もあるので調査が必要です。
                    </li>
